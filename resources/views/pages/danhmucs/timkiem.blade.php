         ...
         <div class="row">
            <div class="col-xs-6">
               <div class="yoast_breadcrumb hidden-xs">
                  <span>
                     <span>
                        <a>{{$danhmuc_slug->title}}</a> » 
                        <span class="breadcrumb_last" aria-current="page">2023</span>
                     </span>
                  </span>
               </div>
            </div>
   ...
   <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
      <section>
         <div class="section-bar clearfix">
            <h1 class="section-title"><span>phim theo từ khoá: {{$search}}</span></h1>
         </div>
         <div class="halim_box">
            @foreach($phim_dm as $key =>$phim)
         ...
         <div class="text-center">
            {{ $phim_dm->links('pagination::bootstrap-4') }}
         </div>
      </section>
   </main>
